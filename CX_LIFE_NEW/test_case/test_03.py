...
class TestCase03(unittest.TestCase):
    ...
    def test_007(self):
        """不结算商品1"""
        self.shopping_cart_page.click_select_two()
    ...
    def test_012(self):
        """清空购物车"""
        for i in range(2):
            self.baseaction.back()
        self.navigation_bar_page.click_shopping_cart()
        self.shopping_cart_page.click_delete_one()
        self.assertTrue(self.shopping_cart_page.assert_go_shoping(), msg="购物车未清空")
